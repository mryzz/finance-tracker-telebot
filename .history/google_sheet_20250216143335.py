...
class GoogleSheets:
    ...
    def check_detail_balance(self, range_name):
        """Reads data of a range from a Google Sheet."""
        try: 
            sheet = self.service.spreadsheets()
            range_names = ["A:A", "B:B", "C:C", "D:D", "E:E", "F:F", "G:G", "H:H", "I:I", "J:J", "K:K", "L:L", "M:M", "N:N", "O:O", "P:P", "Q:Q", "R:R", "S:S", "T:T", "U:U", "V:V", "W:W", "X:X", "Y:Y", "Z:Z"]
...
print(google_sheets.check_balance("A:A"))