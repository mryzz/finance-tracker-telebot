...
def login_message(message):
    ...
    # Create OAuth flow
    flow = InstalledAppFlow.from_client_secrets_file("credentials.json", SCOPES, redirect_uri="http://localhost:5000/")
    auth_url, _ = flow.authorization_url(port=5000, prompt="consent", access_type="offline")
