...
class GoogleSheets:
    ...
    def check_balance(self):
        ...
        try: 
            ...
            range_names = ["'Compute (2025)'!H:H", "'Compute (2025)'!I:I", "'Compute (2025)'!J:J", "'Compute (2025)'!K:K", "'Compute (2025)'!L:L"]
            result = (
                sheet
                .values()
    ...
    def append_values(self, _values):
        ...
        try:
            ...
            range_names = "'Data (2025)'!B1:E5"
            values = [[datetimenow, _values[0], _values[1], _values[2]]]
            values = [[datetimenow, _values[0], _values[1], _values[2]]]
            body = {"values": values}
            result = (
                sheet
